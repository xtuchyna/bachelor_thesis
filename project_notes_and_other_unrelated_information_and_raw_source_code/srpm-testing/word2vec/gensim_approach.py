...
model = gensim.models.Word2Vec(
        ...
        sg=0,
        cbow_mean=1)
model.train(trans, total_examples=len(trans), epochs=300)

print(model.wv.most_similar(positive=['gcc', 'openssl-devel', 'systemd']))
print(model.predict_output_word(['gcc', 'openssl-devel', 'systemd'], topn=10))
